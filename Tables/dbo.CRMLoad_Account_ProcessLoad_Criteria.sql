...
GO
ALTER TABLE [dbo].[CRMLoad_Account_ProcessLoad_Criteria] ADD CONSTRAINT [PK_CRMLoad_Account_ProcessLoad_Criteria] PRIMARY KEY CLUSTERED  ([SSB_CRMSYSTEM_ACCT_ID], [ObjectType])
GO
